// $Id: MOD.h,v 1.9 2013/02/09 19:00:34 david Exp $ -*- c++ -*-
#ifndef __CDK8_NODE_EXPRESSION_MOD_H__
#define __CDK8_NODE_EXPRESSION_MOD_H__
  ...
  namespace node {
    namespace expression {
      ...
      public:
         ...
         */
        inline MOD(int lineno, Expression *left, Expression *right) :
