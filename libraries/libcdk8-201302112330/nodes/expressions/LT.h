// $Id: LT.h,v 1.9 2013/02/09 19:00:33 david Exp $ -*- c++ -*-
#ifndef __CDK8_NODE_EXPRESSION_LT_H__
#define __CDK8_NODE_EXPRESSION_LT_H__
  ...
  namespace node {
    namespace expression {
      ...
      public:
         ...
         */
        inline LT(int lineno, Expression *left, Expression *right) :
