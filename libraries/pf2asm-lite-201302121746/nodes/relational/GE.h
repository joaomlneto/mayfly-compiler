// $Id: GE.h,v 1.3 2013/02/12 18:56:17 david Exp $
#ifndef __PF2ASM_NODE_relational_GE_H__
#define __PF2ASM_NODE_relational_GE_H__
...
namespace pf2asm {
  namespace node {
    namespace relational {
      ...
      class GE: public cdk::node::Node {
      public:
        inline GE(int lineno) :
          cdk::node::Node(lineno) {
        }
        inline const char *name() const { return "GE"; }
