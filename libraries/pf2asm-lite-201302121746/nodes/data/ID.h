// $Id: ID.h,v 1.3 2013/02/12 18:56:15 david Exp $
#ifndef __PF2ASM_NODE_data_ID_H__
#define __PF2ASM_NODE_data_ID_H__
...
namespace pf2asm {
  namespace node {
    namespace data {
      ...
      class ID: public cdk::node::Node {
        std::string _value;

      public:
        inline ID(int lineno, const std::string &value) :
