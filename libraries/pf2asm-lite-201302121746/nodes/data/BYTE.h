// $Id: BYTE.h,v 1.3 2013/02/12 18:56:15 david Exp $
#ifndef __PF2ASM_NODE_data_BYTE_H__
#define __PF2ASM_NODE_data_BYTE_H__
...
namespace pf2asm {
  namespace node {
    namespace data {
      ...
      class BYTE: public cdk::node::Node {
        int _value;

      public:
        inline BYTE(int lineno, int value) :
          cdk::node::Node(lineno), _value(value) {
        }
        inline int value() const {
          return _value;
        }
        inline const char *name() const { return "BYTE"; }
        inline void accept(SemanticProcessor *sp, int level) {
          sp->processBYTE(this, level);
        }
      };
